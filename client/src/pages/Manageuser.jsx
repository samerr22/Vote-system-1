    ...
    <div>
      ...
      <div className="absolute transform -translate-x-0 translate-y-0 top-1 ml-6 ">
        <div className="flex justify-center items-center mb-2">
            <h1 className="font-serif text-white text-3xl ml-28  mb-6 mt-4">
                All Users
            </h1>
        </div>


      <div className="w-[1200px] h-[500px]  ml-32 rounded-lg border shadow-lg shadow-slate-300 border-white bg-slate-100 bg-opacity-35">
